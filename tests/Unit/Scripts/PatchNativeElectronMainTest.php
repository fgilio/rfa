...
{
    $dir = sys_get_temp_dir().'/rfa_test_electron_main_'.getmypid().'_'.uniqid('', true);
    mkdir($dir, 0755, true);
    $path = $dir.'/index.js';
...
afterEach(function () {
    foreach (glob(sys_get_temp_dir().'/rfa_test_electron_main_'.getmypid().'_*', GLOB_ONLYDIR) as $dir) {
