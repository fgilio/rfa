...
final class BrowserDiagnosticSampleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'navigation' => ['nullable', 'array:type,timeOriginMs,fetchStartMs,responseStartMs,responseEndMs,domInteractiveMs,domContentLoadedMs,domCompleteMs,loadEventEndMs,resources'],
            'navigation.type' => ['nullable', 'string', 'max:64'],
            'navigation.timeOriginMs' => ['nullable', 'integer', 'min:0'],
            'navigation.fetchStartMs' => ['nullable', 'integer', 'min:0'],
            'navigation.responseStartMs' => ['nullable', 'integer', 'min:0'],
            'navigation.responseEndMs' => ['nullable', 'integer', 'min:0'],
            'navigation.domInteractiveMs' => ['nullable', 'integer', 'min:0'],
            'navigation.domContentLoadedMs' => ['nullable', 'integer', 'min:0'],
            'navigation.domCompleteMs' => ['nullable', 'integer', 'min:0'],
            'navigation.loadEventEndMs' => ['nullable', 'integer', 'min:0'],
            ...
            'timings' => ['nullable', 'array:longTasks,longTasksDuringAction,longTasksDuringCommit,diffAction,livewireCommit,launch'],
            'timings.launch' => ['nullable', 'array:livewireInitializedMs,settleStartMs,windowLoadMs,fontsReadyMs,firstSettledMs,stableMs,rendererReadyMs'],
            'timings.launch.livewireInitializedMs' => ['nullable', 'integer', 'min:0'],
            'timings.launch.settleStartMs' => ['nullable', 'integer', 'min:0'],
            'timings.launch.windowLoadMs' => ['nullable', 'integer', 'min:0'],
            'timings.launch.fontsReadyMs' => ['nullable', 'integer', 'min:0'],
            'timings.launch.firstSettledMs' => ['nullable', 'integer', 'min:0'],
            'timings.launch.stableMs' => ['nullable', 'integer', 'min:0'],
            'timings.launch.rendererReadyMs' => ['nullable', 'integer', 'min:0'],
