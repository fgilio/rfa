...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.fgilio.rfa'),
     ...
     * nativephp://some/path
     */
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'rfa'),

    /**
     * The author of your application.
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Franco Gilio'),
     ...
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://github.com/fgilio/rfa'),
    ...
    'cleanup_exclude_files' => [
        ...
        'node_modules',
        '*/tests',
        'resources/views/partials/instruckt.blade.php',
    ],
